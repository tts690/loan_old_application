<?php $this->load->view('Bootstrap/header', array('pageTitle' => 'Home Loan Application Residence', 'cssFiles' => array())); ?>


    <meta name="description" content="Apply here for best deals in the market for your housing loan." />
    ...
    <meta property="og:description" content="Apply for home loan to multiple banks with just one single application form here and get unique file tracking id. Get instant call backs from top home loan executives of all banks to serve the purpose."/>
    <!-- End of Open Graph -->
<style type="text/css">
    .form-style-10{
    /*width:450px;*/
    ...
    .form-style-10 h1{
        background: rgba(252, 89, 16, 0.82) !important;
        ...
        border: 1px solid rgba(252, 89, 16, 0.82) !important;
    }
    ...
    .form-style-10 .section{
        font-family: 'GothamRoundedBook';
        font-size: 20px;
        color: rgba(252, 89, 16, 0.82) !important;
        margin-bottom: 5px;
    }
    ...
    .form-style-10 input[type="submit"]{
        ...
        -webkit-box-shadow: inset 0px 2px 2px 0px rgba(255, 255, 255, 0.17);
        box-shadow: inset 0px 2px 2px 0px rgba(255, 255, 255, 0.17);
        border: 1px solid rgba(252, 89, 16, 0.82);
        font-size: 15px;
        margin-bottom: 10px;
    }
            ...
            <div class="row">
                ...
                <div class="col-md-8">
                    <div class="form-style-10">
                        <form action="<?php echo site_url('Home_Loan_App_Res'); ?>" method="POST">
                            <?php
//                            $this->db->select('*');
...
//                            $data = $query->result();
                            ...
                            <div class="inner-wrap">    
                                ...
                                <label>  <select class="form-control" name="sr_loan_id[]" id="selected_loan">
                                    ...
                                    <label> <select name="income_source_id" class="required">
                                            <option>Select Income Source</option>
                                        <option value="R">Resident - Salaried</option>
                                        <option value="S">Resident - Self Employed</option>
                                    </select></label>
                                     <label> 
                                             <input type="text" name="loan_amount" required="required" placeholder="Loan Amount" value="<?php echo $generated_data[0]->loan_amount?>">
                              </label>
                            </div>
                            <div class="section"><span>2</span> Personal Details</div>
                             <div class="inner-wrap">
                                 
                                      <label> <select name="a_title" class="required">
                                ...
                                <label>   <input type="text" name="a_name"  placeholder="Name" value="<?php echo $generated_data[0]->applicant_name; ?>"></label>
                                  <label> 
                                          <textarea name="a_permanent_address" class="required" placeholder="Address"><?php echo $generated_data[0]->a_permanent_address; ?></textarea>
                                </label>
                                
                                <label><input type="text" name="a_res_land" class="required" placeholder="Residence No." value="<?php echo $generated_data[0]->a_res_land; ?>"></label>
                                 <label> <input type="number" name="a_mob" id="num" class="required" placeholder="Mobile No" value="<?php echo $generated_data[0]->a_mob; ?>" required/>
                                  </label>
                                <label>  <input type="text" name="a_office_phone" class="required" placeholder="Office No" value="<?php echo $generated_data[0]->a_office_phone; ?>"></label>
                                   <label>   <input type="email" name="a_email" id="email" class="required" placeholder="Email ID" value="<?php echo $generated_data[0]->a_personal_email; ?>" required/>
                                  </label>
                                <label>    <input type="text" class="datepicker" value="<?php echo $generated_data[0]->a_dob; ?>" name="a_dob" placeholder="DOB"/> </label>
                                   <label>
                                <div class="row">
                            ...
                            <div class="">
                                <div class="col-md-6">
                                    <input type="checkbox" name="check" value="Apply"> I have read and accept the <a href="#"> Privacy Policy</a> 
                                </div>
                                <div class="col-md-6">
