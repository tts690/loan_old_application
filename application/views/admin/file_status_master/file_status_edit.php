<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'File Status Edit', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">File Status Edit</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <?php } ?> 
            <!---End of Alert-->
            <form action="<?php echo site_url('admin/file_edit'); ?>" method="POST">
                <?php
                ...
                ?>
                 <div class="row">
                     <div class="col-md-2 col-xs-12 col-sm-12"> File Name</div>
                        <div class="col-md-4">  
                         <input type="text" name="file_name" value="<?php echo $value->file_status_name; ?>">
                     </div>
                 </div>
