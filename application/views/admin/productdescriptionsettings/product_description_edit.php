<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Edit Product description', 'cssFiles' => array())); ?>
    ...
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
          <section class="page-top">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Product Description Edit</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <form action="<?php echo site_url('admin/product_description/Product_Description_Control/EDIT_Product'); ?>" method="POST">
                <?php
                $id = $this->uri->segment(5);
                $this->db->select('*');
                $this->db->from('sr_product_description');
                $this->db->where(array('sr_product_description_id' => $id));
                $query = $this->db->get();
                $data = $query->result_array();
                foreach ($data as $resulting) {
                ...
                <div class="group-swapping">
                    ...
                    <div class="form-group  select-group">                        
                        <div class="col-md-4 col-xs-12 col-sm-6"> <label> Income Source </label></div>
                    ...
                    <input type="hidden" value="<?php echo $id = $this->uri->segment(5); ?>" name="editing_id"/>
                     <div class="row">
                    <div class="form-group  select-group">                        
                        <div class="col-md-4 col-xs-12 col-sm-6"><label>Select Bank </label></div>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                      ...
                      <div class="row">
                    <div class="form-group select-group">                        
                        <div class="col-md-4 col-xs-12 col-sm-6"><label> Loan </label></div>
                        <div class="col-md-6 col-xs-12 col-sm-6">
                ...
                <div class="form-group selDiv select-group">                        
                    <div class="text-editor">
                        <div class="col-md-4 col-xs-12"> <label>Admin and Processing Fee </label> </div>                   
                        <div class="col-md-8 col-xs-12">  
                            <textarea id="" name="processing_fee" rows="15" cols="72" style="width: 82.33%" class="tinymce">                       
<?php echo $resulting['adminprocessingfee']; ?>
                            </textarea>
                        </div>
                    </div>          
                </div>
                ...
                <div class="form-group selDiv select-group">                        
                    <div class="text-editor">
                        <div class="col-md-4 col-xs-12"><label>Description </label></div>                    
                        <div class="col-md-8  col-xs-12">  
                            <textarea id="" name="description" rows="15" cols="72" style="width: 82.33%" class="tinymce">                       
<?php echo $resulting['description']; ?>
                            </textarea>
                        </div>
                    </div>           
                </div>
               ...
               <div class="row">
                <div class="form-group selDiv select-group">                        
                    <div class="text-editor">
                        <div class="col-md-4 col-xs-12"><label>Sanction Conditions </label>   </div>                 
                        <div class="col-md-8  col-xs-12">
                            <textarea id="" name="sanction" rows="15" cols="72" style="width: 82.33%" class="tinymce">                       
<?php echo $resulting['sanction_conditions']; ?>
                            </textarea>
                        </div>
                    </div>           
                </div>
...
<?php echo $resulting['legal_technical']; ?>
                            </textarea>
                        </div>
                    </div> 
                </div>
                ...
                <div class="form-group selDiv select-group">                       
                    <div class="text-editor">
                        <div class="col-md-4  col-xs-12"><label>Disbursement Conditions </label> </div>                   
                        <div class="col-md-6  col-xs-12">  
                            <textarea id="" name="disbursement" rows="15" cols="72" style="width: 82.33%" class="tinymce">                       
<?php echo $resulting['disbursement']; ?>
                            </textarea>
                        </div>
                    </div>                     
                </div> 
                ...
                <div class="form-group selDiv select-group">                        
                    <div class="text-editor">
                        <div class="col-md-4 col-xs-12"> <label>Pre Closure Conditions </label></div>                    
                        <div class="col-md-6 col-xs-12">
                            <textarea id="" name="closure" rows="15" cols="72" style="width: 82.33%" class="tinymce">                       
<?php echo $resulting['pre_closure']; ?>
                            </textarea> 
                        </div>               
                    </div>
                </div>
                ...
                <div class="row">
                    <input type="submit" class="sbutton" id="cbuton" value="Submit" />             
                </div>
            </form>    
        </div>
</body>
