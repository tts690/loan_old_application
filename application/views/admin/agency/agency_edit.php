<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Agency Edit', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Agency Create</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <form action="<?php echo site_url('admin/agency_edit'); ?>" method="POST">
                <?php
                ...
                <div class="row">
                    <div class="col-md-2 col-xs-12"> State</div><div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-2 col-xs-12"> City</div> 
                    <div class="col-md-4">
                ...
                <div class="row">
                    <div class="col-md-2 col-xs-12"> Bank</div> <div class="col-md-4"> 
                ...
                <hr/>
                <div class="row">
                    <div class="col-md-2 col-xs-12">User Id</div> <div class="col-md-4"> 
