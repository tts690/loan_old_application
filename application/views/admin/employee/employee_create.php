<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Employee Create', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Manage Employee Create</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <?php } ?> 
            <!---End of Alert-->
            <form action="<?php echo site_url('admin/create_control_employee'); ?>" method="POST">
           ...
           <div class="row">
                    <div class="col-md-2 col-xs-12">DOB</div><div class="col-md-4"> <input type="text" name="dob" class="datepicker" value="<?php echo $value->dob; ?>"></div>
                </div>
                <hr/>
                ...
                <div class="row">
                    <div class="col-md-2 col-xs-12"> Password </div> <div class="col-md-4"> <input type="password" name="password" value="<?php echo $value->user_name; ?>"></div>
                </div>
               
                <div class="row">
                    <div class="col-md-2 col-xs-12"> Confirm Password </div> <div class="col-md-4"> <input type="password" name="confirmpass"></div>
                </div>
