<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Documents Controlling Edit', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
            ...
            <form action="<?php echo site_url('admin/edit_document'); ?>" method="POST">
                <?php
                ...
                <div class="col-md-2 col-xs-12">  Documents Code</div>
                <div class="col-md-4">
                    <input type="text" name="doc_code" value="<?php echo $value->doc_code; ?>">
                </div>
                <div class="col-md-2 col-xs-12">Documents Name</div>
                <div class="col-md-4"><input type="text" name="doc_name" value="<?php echo $value->doc_name; ?>">
                    <div>
                        <div class="col-md-8">            
