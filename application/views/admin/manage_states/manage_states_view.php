<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Manage States View', 'cssFiles' => array())); ?>
    ...
    <section class="page-top badmin">
        <div class="container">
            ...
            <div class="table-menu">
                <a href="<?php echo site_url('admin/creation_state'); ?>" class="btn btn-primary">Create Manage States</a>
                <a href="<?php echo site_url('admin/city_control'); ?>" class="btn btn-primary">Create Manage City</a>
                <a href="<?php echo site_url('admin/state_bank'); ?>" class="btn btn-primary">State Banks</a>
            </div> 
