<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Process Create', 'cssFiles' => array())); ?>
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
          ...
          <section class="page-top">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Process Master Create</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <form action="<?php echo site_url('admin/master_file_create'); ?>" method="POST">
