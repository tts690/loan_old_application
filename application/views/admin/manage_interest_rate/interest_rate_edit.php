<?php $this->load->view('admin/components/page_head', array('pageTitle' => 'Interest Rate Edit', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <ul class="breadcrumb">
                                ...
                                <li class="active">Interest Rate Edit</li>  
                            </ul>
                        </div>
                    </div>
                </div>
            ...
            <?php echo form_open_multipart('admin/edit_interest_rate', array('class' => 'col s12')); ?>

            <?php
            $id = $this->uri->segment(5);
            $this->db->select('*');
            $this->db->from('sr_interest_rate');
            $this->db->where(array('intrest_rate_id' => $id));
...
//                die();
            ...
            <div class="row" >
                <div class="text-editor">
                    <div class="col-md-4">     <label>Interest Rates</label></div>
...
<?php echo $value->interest_rate; ?>
            ...
            <div class="row">                   
                <div class="form-group">
                    <div class="col-md-4">
                        <label class="" for="photoUrl">Bank Logo </label>
                    </div>
                    <div class="col-md-4">
            ...
            <div class="row" >
                <div class="text-editor">
                    <div class="col-md-4">     <label>Tenure</label>       </div>             
                    <div class="col-md-6">  <textarea id="" name="tenure" rows="10" cols="72" style="width: 53.33%" class="tinymce">                       
<?php echo $value->tenure; ?>
                        </textarea></div>
                </div>
            </div> 
            ...
            <div class="row" >
                <div class="text-editor">
                    ...
                    <div class="col-md-6"> <textarea id="" name="about" rows="10" cols="72" style="width: 53.33%" class="tinymce">                       
<?php echo $value->about; ?>
            ...
            <div class="row" >
                <div class="text-editor">
                    <div class="col-md-4">   <label>Features</label>      </div>               
                    <div class="col-md-6"> <textarea id="" name="features" rows="10" cols="72" style="width: 53.33%" class="tinymce">                       
<?php echo $value->feature; ?>
            ...
            <div class="row" >
                <div class="form-group">
                    ...
                    <div class="col-md-6"><input type="text" name="title" placeholder="Enter Title..." value="<?php echo $value->title; ?>"/></div>
                </div>
            </div> 
            <div class="row" >
                <div class="form-group">
                    <div class="col-md-4">    <label>Description</label></div>
                    <div class="col-md-6"> <textarea class="form-control" rows="3" placeholder="Enter Description..." name="description"><?php echo $value->description; ?></textarea></div>
                </div>
            </div> 
         
            <div class="row" >
                <div class="form-group">
                    <div class="col-md-4">  <label>Keywords</label></div>
                    <div class="col-md-6"><input type="text" name="keywords" placeholder="Enter Keywords..." value="<?php echo $value->keyword; ?>"/></div>
                </div>
            </div>        
