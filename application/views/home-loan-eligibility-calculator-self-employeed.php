<?php $this->load->view('Bootstrap/header', array('pageTitle' => 'Self Employed Home Loan Eligibility Calculator – Myloandetails.com', 'cssFiles' => array())); ?>
<?php $staticContent = base_url(); ?>
<link rel="stylesheet" href="<?php echo $staticContent; ?>css/jquery_ui.css">
<meta name="description" content="You find it hard to calculate your eligibility for being a self-employed just use this simplified self-employed home loan eligibility calculator to know what is your eligibility and how much you loan can avail without any hassles">
<meta name="keywords" content="Self employed home loan eligibility calculator,self employed loan calculator,self employed housing loan eligibility calculator,self employed loan calculator,self employed calculator">
<!--piechart-->
...
<div role="main" class="main">
    <section class="page-top">
        <div class="container">
            <div class="row">
                <div class="col-md-12">
                    <h1><img src="<?php echo $staticContent; ?>images/icons/self_employed_cal.png"></h1>
                    <ul class="breadcrumb">
                        <li class="breadcrumbtxt"><a href="<?php echo base_url(); ?>" style="color:#CCCCCC">Home</a></li> 
                        <li class="active">Self Employed Home Loan Eligibility Calculator</li>
                    </ul>
                </div>
            </div>
        </div>
    ...
    <div class="inner-content">
        <div class="container">  
            <div class="col-md-8">
                <div class="form-style-3">                   
                    <form action="javascript:alert('submitted');" method="POST">
                        <fieldset><legend>Self Employed Home Loan Eligibility Calculator</legend>
                            ...
                            <input type="hidden" id="calc_type" name="calc_type" value="S" />
                            ...
                            <label for="field2"><span>Loan <span class="required"></span></span>
                            ...
                            <label for="field1"><span>Date of Birth <span class="required"></span></span><input type="text" class="input-field"  id="datepicker" value="<?php echo (isset($userdata[0]->dob)) ? $userdata[0]->dob : ''; ?>" name="dob"/></label>
                            <label for="field1">
                            ...
                            <label for="field1">
                                <span>Annual Gross Profit <span class="required"></span></span>
                                <input type="text" class="input-field" name="monthly_gross_profit" placeholder="Average of 3 years" id="monthly_gross_profit"/> INR
                            </label>
                            <label for="field1"><span>Annual Depreciation<span class="required"></span></span>
                                <input type="text" id="annual_depriciation" name="annual_depriciation" />
                            </label>
                            <label for="field1"><span>Annual Tax Paid<span class="required"></span></span>
                                <input type="text" name="annual_tax_paid" id="annual_tax_paid" />
                            </label>
            ...
            <div class="col-md-4">
                <aside class="side">
                    <div id='myChart'></div>                   
                    <div class="row"><div class="col-md-5 col-sm-3" id="sam">&nbsp;Eligibility</div><div class="col-md-7"> <input type="text" name="eligibility" id="home_loan_eligibility" readonly/>*Lakhs</div></div>
                    <div class="row"><div class="col-md-5 col-sm-3" id="rsam">&nbsp;EMI /Month</div><div class="col-md-7"><input type="text" name="emi_per_month" id="emi_per_month" readonly/></div></div>
                    <div class="row"><div class="col-md-5 col-sm-3" id="gsam">&nbsp;EMI / Lakh</div><div class="col-md-7"><input type="text" name="emi_per_lac" id="emi_per_lac" readonly/></div></div>
...
<script>
    $(document).ready(function () {
        $('#submitButton').click(function () {
            ...
            var monthly_gross_profit = $('#monthly_gross_profit').val();
            var annual_description = $('#annual_description').val();
            var annual_tax_paid = $('#annual_tax_paid').val();            
            
               $.ajax({
                url: siteurl + 'Home_Loan_Eligibility_Calculator_Self_Employeed/calc_resident_selfemployed_eligibility',
                type: 'POST',
                dataType: 'json',
                data: {'calc_type': calc_type,'selected_bank': selected_bank,'tenure': tenure,'roi': roi,'liabalities': liabalities,'LiabilitiesAmt': LiabilitiesAmt,'monthly_gross_profit': monthly_gross_profit,'annual_description': annual_description,'annual_tax_paid': annual_tax_paid},
...
<script>
    $(document).ready(function () {
        $('#selected_loan').change(function () {
            ...
            $.ajax({
                url: siteurl + 'Home_Loan_Eligibility_Calculator_Self_Employeed/interest_tenure',
                type: 'POST',
                dataType: 'json',
...
<script>
    $(document).ready(function () {
        $('#selected_bank').change(function () {
            ...
            $.ajax({
                url: siteurl + 'Home_Loan_Eligibility_Calculator_Self_Employeed/selecting_bank',
                type: 'POST',
                dataType: 'json',
...
<script>
    $(document).ready(function () {
        $('#datepicker').change(function () {
            ...
            $.ajax({
                url: siteurl + 'Home_Loan_Eligibility_Calculator_Self_Employeed/ageCalculator',
                type: 'POST',
                dataType: 'json',
