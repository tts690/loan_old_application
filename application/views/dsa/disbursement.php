<?php $this->load->view('dsa/components/page_head', array('pageTitle' => 'Dashboard', 'cssFiles' => array())); ?>
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
            ...
            <div class="col-md-6">                
                <div class="dlet" style="">
                    ...
                    <form action="<?php echo site_url('dsa/disbursment_creation'); ?>" method="POST">
            ...
            <div class="">
                <div class="col-md">  
                    <div class="table-menu">
                        <a href="<?php echo site_url('dsa/Disbursement_doc'); ?>" class="btn btn-primary">Create </a>
                    </div> 
                            ...
                            <?php if ($data) { ?>
                                <?php foreach ($data as $value) { ?>
                                    <tr>
                                        ...
                                        <td><a href="<?php echo site_url('dsa/Disbursement/EDIT_disbursement_doc/' . $value->disbursment_document_id) ?>" class="btn btn-primary sbutton">Edit</a></td>
                                        <td><a href="<?php echo site_url('dsa/Disbursement/Deleteing_disbursement_doc/' . $value->disbursment_document_id) ?>" class="btn btn-primary sbutton">Delete</a></td>
                                    </tr>
                                <?php } ?>
                            <?php } ?>
                        </tbody>
