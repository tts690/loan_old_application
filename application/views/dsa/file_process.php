<?php $this->load->view('dsa/components/page_head', array('pageTitle' => 'File Process', 'cssFiles' => array())); ?>
    ...
    <div class="container body">
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
            ...
            <div class="col-md-8 center-block">
                ...
                <form action="<?php echo site_url('dsa/File_process'); ?>" method="POST"> 
                    <div class="row"> 
...
//                            $datas = $query->result();
            ...
            <div class="row">  
                <div class="col-md-8 center-block">
                    ...
                    <div class="col-md-4 col-xs-12 col-sm-12"><p>Sanction </p></div>
                    <div class="col-md-2">
            ...
            <div class="col-md-8 center-block" id="propertydetails">
                <div class="row">  
                    ...
                    <div class="col-md-4  col-xs-12 col-sm-12"><p>Remarks</p></div>
                    <div class="col-md-4">  <div class="form-group"><textarea class="form-control" rows="2" col="3" id="leg_app_remarks" name="leg_app_remarks"></textarea> </div></div>
                    <div class="col-md-4">  <div class="form-group"><textarea class="form-control" rows="2" col="3" id="leg_co_remarks" name="leg_co_remarks"></textarea></div></div>
                    <div class="col-md-4 col-xs-12 col-sm-12"><p>Amount</p></div>
                    <div class="col-md-4">  <div class="form-group"><input type="text" class="" id="leg_app_amount" value="" name="leg_app_amount"/> </div></div>
                    <div class="col-md-4">  <div class="form-group"><input type="text" class="" id="leg_co_amount" value="" name="leg_co_amount"/></div></div>
                </div> 
            </div>
            <!--content-->
...
<script>
    $(document).ready(function () {
        $('.process_id').change(function () {
            ...
            $.ajax({
                url: siteurl + 'dsa/Login/Select_File_Process_Status',
                type: 'POST',
                dataType: 'json',
...
<script>
    $(document).ready(function () {
        $('#income_source').change(function () {
            var income_source = $('#income_source').val();
            $.ajax({
                url: siteurl + 'dsa/File_process/Select_File_Process_Verification',
                type: 'POST',
                dataType: 'json',
                data: {'income_source': income_source},
                success: function (result) {
...
<script>
    $(document).ready(function () {
        $('#app_process_process_type_id').change(function () {
            ...
            $.ajax({
                url: siteurl + 'dsa/File_process/Select_File_Process_Verification_process',
                type: 'POST',
                dataType: 'json',
                data: {'process_id': process_id},
                success: function (result) {
...
<!--   Eligibility and Sanction Applicant Process Type --->
...
<script>
    $(document).ready(function () {
        $('#eli_app_process_type_process_id').change(function () {
            ...
            $.ajax({
                url: siteurl + 'dsa/Login/Select_Eligibality_Status',
                type: 'POST',
                dataType: 'json',
...
<!--   Eligibility and Sanction Co Applicant Process Type --->
...
<!--   Legal and Technical:  Applicant Process -->

<script>
    $(document).ready(function () {
        $('#leg_app_process_type_process_id').change(function () {            
            var process_id3 = $('#leg_app_process_type_process_id').val();
...
<script>
    $(document).ready(function () {
        $('#leg_co_process_type_process_id').change(function () {            
            var process_id3 = $('#leg_co_process_type_process_id').val();
            $.ajax({
                url: siteurl + 'dsa/Login/Select_Eligibality_Status',
                type: 'POST',
                dataType: 'json',
