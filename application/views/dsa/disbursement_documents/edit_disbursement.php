<?php $this->load->view('dsa/components/page_head', array('pageTitle' => 'Edit Disbursement', 'cssFiles' => array())); ?>
        ...
        <div class="right_col" role="main" style="min-height: 1296px;">
            ...
            <div class="colr-block">
                ...
                if ($query->num_rows() > 0) {
                    $data = $query->result();
                    ?>
                    <form action="<?php site_url('dsa/create_disbursement'); ?>" method="POST">
                        <input type="hidden" value="<?php echo $id = $this->uri->segment(4); ?>" name="editing_id"/>
                            ...
                            <div class="urc">
                                <div class="row">
                                    ...
                                    <div class="col-md-3">
                                        <select class="forcontrol" name="income_source_id" id="income_source">
