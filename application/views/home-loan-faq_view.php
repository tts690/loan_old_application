<?php $this->load->view('Bootstrap/header', array('pageTitle' => 'Get your Home Personal Business Mortgage loans Cibilfaqs resolved – Myloandetails.com', 'cssFiles' => array())); ?>
                ...
                <div class="col-md-12">
                    ...
                    <ul class="breadcrumb">                        
                        <li class="breadcrumbtxt"><a href="<?php echo base_url(); ?>">Home</a></li> 
                         <li class="breadcrumbtxt"><a href="<?php echo site_url('post-a-query'); ?>">Frequently Asked Questions</a></li> 
                        <li class="active">Frequently Asked Question and Answers</li>
                    </ul>
                </div>
            </div>
        </div>
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="question-grid col-md-12">
                        ...
                        $this->db->where('faq_question_id', $faq_id);
                        $query = $this->db->get();
                        $data = $query->result();
                        ?>
                        <?php foreach ($data as $result) { ?>                   
                            ...
                            <div class="col-md-12 ">  
                                <div class="ans">
                                    <div class="question">
                                        <h4><span class="label">Question&nbsp;:</span><span> <?php echo ucfirst($result->question); ?></span></h4>
                                    </div>
                                    <div class="question">
                                        <h4><span class="label"> Author&nbsp;:</span><spam>  <?php echo ucfirst($result->name); ?></spam></h4>
                                    </div>
                                    <?php
                                    $this->db->select('*');
                                ...
                                <?php foreach ($data_res as $res_data_testing) { ?>

                                    <div class="well">
                                        <div class="col-md-3 rating" align="center">                         
                                            <div class="stars">                           
                                                <center>  <i class="fa fa-star fa-5x" aria-hidden="true" style="color:#7f7f7f; margin-bottom: 15px; "></i>
                                                </center>
                                            </div>
                                            <p data-id="<?php echo $result->rating; ?>" class="rating_system"><?php echo $result->rating; ?></p>   
                                            <div class="rate"><label class="">Rating&nbsp;: <span data-id="<?php echo $res_data_testing->rating; ?>" class="users_rating"><?php echo $res_data_testing->rating; ?></span></label>

                                            </div>
                                        </div>
                                        <div class="col-md-9 rquery">
                                            <div class="answer">
                                      Answer&nbsp;: <span><p><?php echo $res_data_testing->answer; ?></p></span>
                                            </div>                                         
                                            ...
                                            <div class="links">
                                                <ul>
                                                    ...
                                                    <li><a href="#"><i class="fa fa-comments" aria-hidden="true"></i>
                                                            : <?php echo $res_data_testing->answered_by; ?></a></li>
                                                    <?php
                            ...
                            <div class="">
                                <div class="panel panel-login">
                                    ...
                                    <div class="panel-body">
                                        <div class="row">
                                            <div class="col-lg-12">
                                                <form id="login-form" action="<?php echo site_url('Home_Loan_Faq/signin/' . $result->faq_question_id); ?>" method="POST" role="form" style="display: block;">
