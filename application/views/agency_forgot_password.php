<?php $this->load->view('Bootstrap/header', array('pageTitle' => 'Home Loan FAQ Status', 'cssFiles' => array())); ?>
...
<div role="main" class="main">
    ...
    <div class="inner-content">
        <div class="container">
            <form action="<?php echo site_url('Dsa_Register/forgot_password'); ?>" method="POST">
                    ...
                    <div class="dsalogin">
                        <div class="form-style-3">
                            <fieldset>
                                ...
                                <span></span> <input type="submit" class="btn btn-primary cr"/>
                            </fieldset>
                        </div>
                    </div>
                </div>
