                ...
                <table width="600" cellpadding="0" cellspacing="0" bgcolor="#FFFFFF">
                    <tr>
                        <td bgcolor="#FFFFFF" valign="" width="400" colspan="2">
                            ...
                            <p>Greetings,</p>
                            <p> Thank you for choosing us for your loan service requirements and we would be happy 
                                to help you in getting the loan done at the earliest with best possible interest 
                                rates and with hassle free repayment options. Please review the details that you have submitted below
                                and if you want to change/update the application you can do it<a href="<?php 
                      if($userData['income_source_id'] == "R") {
                                        echo site_url('Home_Loan_App_Res?id='.$userData['generate_file_id']);
                                    }else if($userData['income_source_id'] == "N"){
                                        echo site_url('Home_Loan_App_Nri?id='.$userData['generate_file_id']);
                                    }else{
                                        echo site_url('Home_Loan_App_Res?id='.$userData['generate_file_id']);
                                    }                                
                           ...
                           <div class="email-datails">
                               <table class="responsive" style="border-collapse: collapse; border:1px solid black;" >
                                ...
                                <br/>                         
                            <p>Our representative will get in touch with you soon to serve you better.</p>
                            <p>If you have any queries regarding your loans and want an expert advice you can post it<a href="<?php echo site_url('Home_Loan_Faq'); ?>"> here</a>
                            </p>
