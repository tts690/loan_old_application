<?php $this->load->view('employee/components/page_head', array('pageTitle' => 'Create Disbursement', 'cssFiles' => array())); ?>
...
<body class="nav-md">
    <div class="container body">
        ...
        <!--Bug Alerts--->
            ...
            <?php } ?> 
         <!--Bug Alerts--->
            <form action="<?php site_url('employee/Disbursement/create_document'); ?>" method="POST">
