<?php $this->load->view('employee/components/page_head', array('pageTitle' => 'Search', 'cssFiles' => array())); ?>
                    ...
                    <tbody>
                        <?php foreach ($data as $value) { ?>
                            <tr>
                                ...
                                <td><a href="<?php echo site_url('employee/Search/EDIT_file/' . $value->generate_file_id) ?>" class="btn btn-primary">Edit</a></td>
                            </tr>
                        <?php } ?>
                    </tbody>
                </table>
