        ...
        <div class="emi-header">
            ...
            <div class="row">
                <div class="col-md-12 product-form">
                    <div class="row">                       
                            <p> To start with the home loan processing a customer need to submit the documents and this will vary depending on the product and the income source of the customer. To avoid this confusion to our customers we are here giving a simple process to get their required list of documents which are applicable to their product. So go ahead a select the required fields and get the list of documents required to start with your processing.</p>
                    ...
                    <form id="testform4" method="post" action="<?php echo site_url('Document_Description/Get_Documents') ?>">
                                                            ...
                                                            <label class="radio">
                                                                <label for="selected_value">
                                                                    <div class="hvr-puls">
                                                                        ...
                                                                        <div class="radio-box">
                                                                            <input type="radio" name="income_source_id" data-selection="Resident Salaried" data-action="change:edit"
                                                                                   id="selected_value"
                                                                                   value="R"
                                                                                   data-toggle="radio" 
                                ...
                                <div class="row-fluid">
                                    <div class="row">
                                        <div class="row ns-fixed-height">
                                            ...
                                            <div class="col-md-12 news-tagger-content">
                                                <div class="row news-tagger-city">
                                                    <div class="cityNameDiv col-xs-12 col-sm-6 col-md-6 text-center pad-none hover-icon">
                                                        <div class="touch-icon touch-icon-active">
                                                            <label class="radio">
                                ...
                                <div class="row-fluid">
                                    <div class="row">
                                        <div class="row ns-fixed-height">
                                            ...
                                            <div class="col-sm-11 col-md-12  pl-salary-account salary-bank">
                                                <div class="row news-tagger-content news-tagger-salary-deposited">
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        ...
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    ...
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="2" class="basic-required-options" slideNextOn="change" data-action="change:edit:inclData" id="salaryAccount_radio_02" name="sr_loan_id" data-toggle="radio"   />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                        </div>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_998"> <span class="sprite-bank-desk icon-receive hvr-outline-out"> </span> <span class="bank-name">Resale purchase( Vendor already has a loan )</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="8" id="salaryAccount_radio_998" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_2013"> <span class="sprite-bank-desk Resale-Puchase-2013 hvr-outline-out"> </span> <span class="bank-name">Resale Puchase (Flat or Independent House</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="2" id="salaryAccount_radio_2013" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_2015"> <span class="sprite-bank-desk balancetransfer2015 hvr-outline-out"> </span> <span class="bank-name">Balance Transfer(BT) + PLOT Mortgage</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="12" id="salaryAccount_radio_2015" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_2016"> <span class="sprite-bank-desk Balance-Transfer-2016 hvr-outline-out"> </span> <span class="bank-name">Balance Transfer(BT) + Top-up</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="13" id="salaryAccount_radio_2016" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_2019"> <span class="sprite-bank-desk Loan-Extension-2019 hvr-outline-out"> </span> <span class="bank-name">Loan Extension</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="14" id="salaryAccount_radio_2019" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                                    ...
                                                    <div class="col-md-3 col-xs-12 col-sm-4 loan-select">
                                                        <div class="touch-icon">
                                                            <label class="radio">
                                                                <div class="hvr-puls">
                                                                    <label for="salaryAccount_radio_2018"> <span class="sprite-bank-desk Top-Up-2018 hvr-outline-out"> </span> <span class="bank-name">Top Up</span> </label>
                                                                    <div class="radio-box">
                                                                        <input type="radio" value="14" id="salaryAccount_radio_2018" data-action="change:edit:inclData"
                                                                               name="sr_loan_id" class="validate basic-required-options" slideNextOn="change" data-toggle="radio"  />
                                                                    </div>
                                                                </div>
                                                            </label>
                                        ...
                                        <!--div class="col-md-12">
                                            ...
                                            <!--div class="col-md-9">
                                                <input type="submit" value="Submit" class="btn btn-primary pull-right" data-loading-text="Loading...">
                                            </div-->
                                        </div>
                                    </div>
                                </div>
