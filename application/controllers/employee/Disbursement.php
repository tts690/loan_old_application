...
class Disbursement extends Employee_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('employee/Setting_disbursement_process', 'esdp');
    }

    public function index() {
        $this->outputData['data'] = $this->esdp->get_disbursement_document();
        $this->load->view('employee/disbursement', $this->outputData);
    }
    ...
    public function create_document() {
        ...
        $this->load->view('employee/disbursement_documents/create_disbursement', $this->outputData);
    }
    ...
    public function EDIT_disbursement_doc() {
        ...
        $this->load->view('employee/disbursement_documents/edit_disbursement', $this->outputData);
    }

    public function Deleteing_disbursement_doc() {
        $id = $this->uri->segment(4);
        if ($this->esdp->doc_disbursement_delete($id)) {
            redirect('employee/Disbursement');
        } else {
            redirect('employee/Disbursement');
        }
        $this->load->view('employee/disbursement_documents');
    }
