 ...
 * @author HemanthRaj
 */
class Login extends Employee_Controller {
    ...
    public function __construct() {
        ...
        $this->load->model('employee/File_login', 'fl');
    }

    public function index() {
//        $this->outputData['data'] = $this->fl->get_file_process_status();
//        $this->load->view('employee/login', $this->outputData);
    ...
    public function Generate_URC_File() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            $message3 = "Welcome to My loan Details for testing Message";
    ...
    public function selecting_state() {
        $data = array();
        $data['sr_state_id'] = $_POST['selecting_state_id'];        
        $this->outputData['result'] = $this->fl->select_state($data);
