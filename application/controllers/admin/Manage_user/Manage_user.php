...
class Manage_user extends Admin_Controller {
    ...
    public function __construct() {
        parent::__construct();
        $this->load->model('admin/Manage_User/User_Setting', 'us');
        if (!isLoggedIn()) {
    ...
    public function index() {
        $this->outputData['data'] = $this->us->select_get_user();
        $this->load->view('admin/manage_user/manage_user_view', $this->outputData);
    }
