...
class Home_Loan_Application_NRI extends Frontend_Controller {
    ...
    function index() {
        ...
        if ($this->form_validation->run() === TRUE) {
            ...
            //$dsa_result['res'] = $this->dsa->check_dsa_id($agency_id);
        ...
        $this->load->view('home-loan-application_nri_salaried', $this->outputData);
    }
